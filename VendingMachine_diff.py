...
def VendingMachine(customerName):
    ...
    print("Hello, %s ! Came to buy a drink?" % (customerName))
    ...
    if wantedDrink in drinkStock and wantedNum <= drinkStock[wantedDrink]:
    ...
    shouldPay = wantedNum * drinkPrice[wantedDrink]
    totalPay = 0
    while totalPay < shouldPay:
        print("You have paid:", totalPay)
        pay = int(input("Please pay by 100, 500, or 1000:")) # can make this a function
